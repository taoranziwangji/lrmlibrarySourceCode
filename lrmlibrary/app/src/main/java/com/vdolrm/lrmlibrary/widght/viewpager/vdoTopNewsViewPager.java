 ...
 * 
 */
public class vdoTopNewsViewPager extends ViewPager {

	int startX;
	int startY;

	public vdoTopNewsViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public vdoTopNewsViewPager(Context context) {
		super(context);
	}
