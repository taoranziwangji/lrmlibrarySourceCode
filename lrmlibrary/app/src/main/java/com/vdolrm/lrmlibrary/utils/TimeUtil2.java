...
public class TimeUtil2 {
     ...
     * @param minute    分钟
     */
    public TimeUtil2(int hour, int minute) {
     ...
     * @param second    秒
     */
    public TimeUtil2(int hour, int minute, int second) {
     ...
     * @param second    秒
     */
    public TimeUtil2(int day, int hour, int minute, int second) {
     ...
     * @param time      字符串格式的时间
     */
    public TimeUtil2(String time, String timeSeparator) {
     ...
     * @return          运算后的时间
     */
    public TimeUtil2 addTime(TimeUtil2 time) {
    	TimeUtil2 result = new TimeUtil2();
        int up = 0;     // 进位标志
     ...
     * @return          运算后的时间
     */
    public TimeUtil2 subtractTime(TimeUtil2 time) {
    	TimeUtil2 result = new TimeUtil2();
        int down = 0;       // 退位标志
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final TimeUtil2 other = (TimeUtil2) obj;
